...
#define STRING_CONFIG_H_AUTHOR "(Greg Holloway, BigBox Direct Dual)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bertha-2"
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 300 // BigBox | 260 for Dual - 300 for Pro
...
#define DEFAULT_ACCELERATION          450    // BigBox | 450 for Dual , 750 for Pro // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  5000    // E acceleration in mm/s^2 for retracts
#define DEFAULT_TRAVEL_ACCELERATION   450    // BigBox | 450 for Dual , 750 for Pro // X, Y, Z acceleration in mm/s^2 for travel (non printing) moves
